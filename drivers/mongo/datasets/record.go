...
func (rec *Dataset) ToDomain() datasets.Domain {
	return datasets.Domain{
		...
		WhoisRegistrar: rec.WhoisRegistrar,
		WhoisRegistrarUrl: rec.WhoisRegistrarUrl,
		WhoisRegistryCreatedAt: rec.WhoisRegistryCreatedAt,
		WhoisRegistryExpiredAt: rec.WhoisRegistryExpiredAt,
		WhoisRegistryUpdatedAt: rec.WhoisRegistryUpdatedAt,
		WhoisDomainAge: rec.WhoisDomainAge,
		RemoteIpAddress: rec.RemoteIpAddress,
		RemotePort: rec.RemotePort,
		RemoteIpCountryName: rec.RemoteIpCountryName,
		RemoteIpIsp: rec.RemoteIpIsp,
		RemoteIpDomain: rec.RemoteIpDomain,
		RemoteIpAsn: rec.RemoteIpAsn,
		RemoteIpIspOrg: rec.RemoteIpIspOrg,
		Protocol: rec.Protocol,
		SecurityState: rec.SecurityState,
		SecurityProtocol: rec.SecurityProtocol,
